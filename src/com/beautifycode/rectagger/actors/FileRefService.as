package com.beautifycode.rectagger.actors {
	...
	public class FileRefService extends Actor {
		...
		private var _loadedObjectData : Object;
		...
		public function loadImagesFromConfig(imagesToLoad : Array, loadedObject : Object) : void {
			_loadedObjectData = loadedObject;
		...
		private function onImageLoadedFromPath(event : Event) : void {
			...
			else onAllImagesLoadedByConfig();
		}

		private function onAllImagesLoadedByConfig() : void {
			thumbnailsmodel.generateThumbnails();

			_e = new FileRefEvent(FileRefEvent.ALL_IMAGES_LOADED, true, false);
			_e.vo = _loadedObjectData;
			dispatch(_e);
		}
	}
}
